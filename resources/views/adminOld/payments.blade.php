    ...
    <div x-data="paymentsManager()" class="max-w-7xl mx-auto">
                        ...
                        <div class="border border-emerald-200 dark:border-emerald-900 rounded-lg p-4 bg-emerald-50/40 dark:bg-emerald-950/20">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <select name="cash_in[customer_id]" class="w-full px-3 py-2 border rounded text-sm bg-white dark:bg-[#081118] border-gray-200 dark:border-[#1a202c]">
                        ...
                        <div class="border border-rose-200 dark:border-rose-900 rounded-lg p-4 bg-rose-50/40 dark:bg-rose-950/20">
                            ...
                            <div class="space-y-3">
                                <div>
                                    ...
                                    <select name="cash_out[customer_id]" class="w-full px-3 py-2 border rounded text-sm bg-white dark:bg-[#081118] border-gray-200 dark:border-[#1a202c]">
        ...
        <div x-show="showEdit" x-cloak class="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div class="bg-white dark:bg-[#0b0e14] rounded-lg shadow-xl w-full max-w-lg z-50 overflow-hidden">
                ...
                <form class="px-6 py-6 space-y-4" @submit.prevent="saveEdit()">
                    <div>
                        <label class="block text-sm font-medium mb-1">Customer *</label>
                        <select x-model="form.customer_id" required class="w-full px-3 py-2 border rounded bg-white dark:bg-[#081118] border-gray-200 dark:border-[#1a202c]">
                            <option value="">--</option>
                            @foreach($customers as $c)
                                <option value="{{ $c->id }}">{{ $c->name }} ({{ $c->city }})</option>
                            @endforeach
