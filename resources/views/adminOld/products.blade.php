    ...
    <div x-data="productManager()" class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between mb-6">
            ...
            <div class="flex items-center space-x-2">
                <button @click="openCreate()" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white rounded-lg shadow hover:opacity-95 focus:outline-none">
