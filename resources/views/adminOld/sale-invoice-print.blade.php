...
<head>
    ...
    @php
        ...
        $netTotal   = $subTotal - $cash;                           // image's "Net Total"
    @endphp
    <style>
...
<body>
    ...
    <table class="meta">
        ...
        <tr>
            <td>M/S : <u>{{ optional($invoice->customer)->name }}</u></td>
            <td class="right"></td>
        </tr>
    </table>
    ...
    <table class="items">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="c" style="border:none; border-bottom:1px solid #000; font-weight:bold;">{{ rtrim(rtrim(number_format($invoice->items->sum('rate'), 2), '0'), '.') }}</td>
