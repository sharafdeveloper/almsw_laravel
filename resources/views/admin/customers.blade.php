                    ...
                    <tbody class="bg-white dark:bg-[#0b0e14] divide-y divide-gray-100 dark:divide-[#11151c]">
                        @forelse($customers as $c)
                            <tr>
                                ...
                                <td class="px-4 py-3 text-sm text-gray-700 dark:text-gray-300">{{ $c->phone_number }}</td>
            ...
            <div class="bg-white dark:bg-[#0b0e14] rounded-lg shadow-xl w-full max-w-lg z-50 overflow-hidden">
                ...
                <form class="px-6 py-6 space-y-4" @submit.prevent="submitForm()">
                    ...
                    <div>
                        ...
                        <input type="text" x-model="form.phone_number" required class="w-full px-3 py-2 border rounded-md bg-white dark:bg-[#081118] border-gray-200 dark:border-[#1a202c] text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-purple-500">
                    </div>
                    <div>
    ...
    <script>
        function customerManager() {
            return {
                ...
                method: 'POST',
                form: { id: null, name: '', phone_number: '', city: '', balance_type: 'dr', opening_amount: '' },
                deleting: { id: null, name: '' },
                openCreate() {
                    this.form = { id: null, name: '', phone_number: '', city: '', balance_type: 'dr', opening_amount: '' };
                    this.method = 'POST';
